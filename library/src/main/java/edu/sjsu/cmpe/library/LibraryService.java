...
public class LibraryService extends Service<LibraryServiceConfiguration> {
	...
	environment.addResource(new BookResource(bookRepository, queueName, topicName, 
			          libraryName, apolloUser,  apolloPassword, apolloHost, apolloPort));

	/** UI Resources */
	environment.addResource(new HomeResource(bookRepository));
	environment.addServerLifecycleListener(new LibraryListener(bookRepository, queueName, topicName, 
            libraryName, apolloUser,  apolloPassword, apolloHost, apolloPort));
    }
}